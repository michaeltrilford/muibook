...
const skillIndex = {
  ...
  skills: [
    ...
    {
      id: "wireframe-to-muibook-components",
      file: "skills/wireframe-to-muibook-components/SKILL.md",
      title: "Wireframe To Muibook Components",
      useWhen: "Interpreting sketches, wireframe drawings, design screenshots, and visual mockups into semantic Muibook Web Components and layouts.",
    },
  ],
};
