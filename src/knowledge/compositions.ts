  ...
  agentChat: {
    ...
    stories: {
      items: [
        ...
        { key: "steer", title: "Steer", description: "Keeps compact, editable task context attached to the follow-up composer.", list: ["Use the Prompt context-above or context-below slot for task context, selected text, constraints, examples, or attachments.", "Keep the context row compact and truncated.", "Use Action Toggle for application-controlled context state such as Web, Files, or Canvas."] },
