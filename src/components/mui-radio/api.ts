export const muiApi = {
  "mui-radio": {
    ...
    members: [
      { kind: "field", name: "checked", type: { text: "boolean" }, description: "Gets or sets whether this radio is selected." },
      { kind: "field", name: "value", type: { text: "string" }, description: "Gets or sets the submitted radio value." },
    ],
    attributes: [
    ...
    events: [{ name: "change", description: "Composed, bubbling event dispatched when selected with `detail.checked`, `detail.value` and `detail.name`." }],
    methods: [{ name: "focus", description: "Moves focus to the internal native radio." }],
  },
};
