export const muiApi = {
  "mui-dialog": {
    ...
    attributes: [
      ...
      { name: "close-shape", type: { text: '"default" | "circle"' }, default: "default", description: "Controls the built-in header close button shape. Use `circle` for a circular icon action." },
