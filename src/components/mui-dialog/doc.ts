  ...
  Dialog: {
    ...
    accessibility: {
      ...
      engineerList: [
        ...
        "When a title slot is present and hide-header is not set, the close button includes aria-label='Close'.",
        "Footer is hidden when empty to reduce screen reader noise.",
        "Clicking the backdrop closes the dialog.",
        "The internal native showModal() call provides modal focus containment and makes the background inert while open.",
    ...
    stories: {
      items: [
        ...
        { key: "media", title: "Media Dialog with Close", description: "Presents a larger preview within the Dialog surface.", list: ["Use max-height when the complete media Dialog needs a viewport-relative cap.", "Keep a title or another clear close action available for preview-only Dialogs."] },
