  ...
  Prompt: {
    ...
    usage: {
      list: [
        ...
        "Use slot='context-summary' for a compact prompt context row above the input when task text and actions need to stay visible.",
        "Let the context summary truncate long task text; do not hard-code ellipsis into the content.",
        "Use slot='context' for expanded prompt context sheet details below the summary row.",
        "Use context-sheet-collapsed to render the context sheet collapsed by default.",
        "Use context-sheet-label to provide a concise accessible label for the sheet toggle.",
        "Keep feature-specific context controls inside the context-summary or context slots; Prompt owns only the attached container, collapse behavior, and visibility.",
    ...
    accessibility: {
      ...
      engineerList: [
        ...
        "Ensure slotted context sheet controls have their own labels and keyboard behavior.",
    ...
    anatomy: { image: "", list: ["Prompt surface", "Context summary slot", "Context detail slot", "Input area", "Action slot"] },
    ...
    behaviour: {
      list: [
        ...
        "Slotted context summary and detail content appears above the prompt input, remains hidden when empty, and can be collapsed or expanded with its header toggle.",
        "Toggling the context sheet emits prompt-context-sheet-toggle with the collapsed state.",
