  ...
  Prompt: {
    ...
    usage: {
      list: [
        ...
        "Use slot='context-above' or slot='context-below' for explicit context content, usually <mui-context-bar>.",
    ...
    behaviour: {
      list: [
        ...
        "Content in context-above or context-below renders on the corresponding side of the prompt surface.",
