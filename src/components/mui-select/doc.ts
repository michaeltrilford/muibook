  ...
  Select: {
    ...
    usage: {
      list: [
        ...
        "Use padding-block and padding-inline to tune custom appearance trigger and option spacing when composed content needs more or less room.",
        "Use selected-content='label' when rich picker options should collapse to plain text in the closed select.",
