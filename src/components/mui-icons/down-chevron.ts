class MuiIconDownChevron extends HTMLElement {
  ...
  render(): void {
    ...
    this.shadowRoot.innerHTML = /*html*/ `
      ...
      >
        <path
          d="M18 26.43c-.79 0-1.428-.28-2.091-.956L6.7 16.075C6.23 15.578 6 15.03 6 14.354c0-1.378 1.122-2.525 2.487-2.525.688 0 1.326.293 1.849.829l7.69 7.944 7.65-7.944c.524-.549 1.161-.83 1.837-.83 1.365 0 2.487 1.148 2.487 2.526 0 .676-.217 1.237-.701 1.708l-9.195 9.412c-.663.663-1.288.956-2.104.956"
        ></path>
      </svg>
