  ...
  Menu: {
    ...
    stories: {
      items: [
        ...
        { key: "states", title: "States", list: ["Use the primary treatment to show the current or selected menu action.", "The active appearance shown here is the base theme treatment; customize it to suit your product theme.", "Disable an action only when it must remain visible but cannot currently be used."] },
      ],
    },
