  ...
  Drawer: {
    ...
    stories: {
      items: [
        ...
        { key: "drawer-close-shape", title: "Close Shape", description: "Uses a circular treatment for the built-in close action.", list: ["Use close-shape='circle' when the close affordance should match circular icon actions elsewhere in the interface.", "The default close treatment remains unchanged when close-shape is omitted."] },
        { key: "drawer-dropdown-portal", title: "Dropdown Portal", description: "Verifies Dropdown Menus in the Drawer body and footer remain visible and interactive above the overlay surface.", list: [] },
        ...
        { key: "drawer-menu", title: "Menu", description: "Uses Drawer as persistent application navigation beside the page.", list: ["Use a push drawer for application navigation that should share space with the page.", "Use panel-padding='none' when navigation content needs to control its own edge-to-edge spacing."] },
