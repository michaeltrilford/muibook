export const muiApi = {
  "mui-profile-chip": {
    ...
    attributes: [
      ...
      { name: "breakpoint", type: { text: "string" }, default: "700", description: "Responsive breakpoint used to switch the avatar between medium and small." },
    ],
    slots: [
    ...
    cssProperties: [
      { name: "--profile-chip-text-color", description: "Text color used by fallback primary and secondary labels." },
      { name: "--profile-chip-secondary-color", description: "Secondary text color used by fallback secondary labels." },
