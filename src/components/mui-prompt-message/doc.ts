  ...
  PromptMessage: {
    ...
    usage: {
      list: [
        ...
        "Use variant='ghost' when the message row should render without surface treatment.",
        "Use density='compact' when padding should be removed for tight compositions.",
