  ...
  SlideFrame: {
    ...
    usage: {
      list: [
        ...
        "Use variant='default|plain|ghost' to control frame chrome.",
        ...
        "Use preview to show warning treatment for draft/unreviewed slide states.",
        "Use lightbox to open slotted image content in a built-in dialog when clicked.",
        "When multiple sections exist, users can navigate with arrow keys or horizontal swipe gestures.",
    ...
    accessibility: {
      designerList: [""],
      engineerList: [
        "The surface is focusable in present mode and supports keyboard section navigation with arrow keys.",
