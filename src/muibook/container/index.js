...
export class AppContainer extends HTMLElement {
  ...
  async loadComponent() {
    ...
    const routes = {
      ...
      "/json-rules": "knowledge-json-rules-page",
      "/knowledge-fragments": "knowledge-fragments-page",
      ...
      "/action-toggle": "story-action-toggle",
      "/context-bar": "story-context-bar",
      "/chat-message": "story-chat-message",
      "/agent-bubble": "story-chat-message",
      "/result-bar": "story-result-bar",
      "/work-log": "story-work-log",
      "/file-diff": "story-file-diff",
      "/preview-chip": "story-preview-chip",
      "/media-player": "story-media-player",
      "/model-viewer": "story-model-viewer",
      "/financial-chart": "story-financial-chart",
      "/financial-bar-chart": "story-financial-bar-chart",
      "/comparison-chart": "story-comparison-chart",
      "/market-sparkline": "story-market-sparkline",
      ...
      "/body": "story-body",
      "/image": "story-image",
      "/file-icon": "story-file-icon",
      "/avatar": "story-avatar",
      "/avatar-group": "story-avatar-group",
    ...
    const importMap = {
      ...
      "knowledge-json-rules-page": () => import("../pages/knowledge/json-rules.js"),
      "knowledge-fragments-page": () => import("../pages/knowledge/fragments.js"),
      ...
      "story-file-icon": () => import("../story/components/mui-file-icon"),
      "story-avatar": () => import("../story/components/mui-avatar"),
      "story-avatar-group": () => import("../story/components/mui-avatar-group"),
      ...
      "story-action-toggle": () => import("../story/components/mui-action-toggle"),
      "story-context-bar": () => import("../story/components/mui-context-bar"),
      "story-chat-message": () => import("../story/components/mui-chat-message"),
      "story-result-bar": () => import("../story/components/mui-result-bar"),
      "story-work-log": () => import("../story/components/mui-work-log"),
      "story-preview-chip": () => import("../story/components/mui-preview-chip"),
      "story-file-diff": () => import("../story/components/mui-file-diff"),
      "story-media-player": () => import("../story/components/mui-media-player"),
      "story-model-viewer": () => import("../story/components/mui-model-viewer"),
      "story-financial-chart": () => import("../story/components/mui-financial-chart"),
      "story-financial-bar-chart": () => import("../story/components/mui-financial-bar-chart"),
      "story-comparison-chart": () => import("../story/components/mui-comparison-chart"),
      "story-market-sparkline": () => import("../story/components/mui-market-sparkline"),
      ...
      "story-color-input": () => import("../story/components/mui-color-input"),
