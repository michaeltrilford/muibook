...
class AgentPromptsPage extends HTMLElement {
  constructor() {
    ...
    shadowRoot.innerHTML = /*html*/ `
      ...
      <story-template 
        title="Agent Prompts"
        description="Reusable task instructions for agent behavior."
          ...
          <mui-grid slot="body" class="config" space="var(--space-600)">
            ...
            <mui-v-stack space="var(--space-600)">
              ...
              <mui-v-stack space="var(--space-400)">
                <mui-body size="large">Agent Prompts are structured instructions designed to define the behavior and responses of AI agents clearly and consistently.</mui-body>
                <mui-body size="large">By formalizing these prompts, you ensure scalable, maintainable, and reusable logic across different AI implementations.</mui-body>
              </mui-v-stack>
